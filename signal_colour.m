...
for test_round = 1:100                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
    ...
    test_round
    clearvars -except detected_num failed_num forced_stop stop_sign detected_num_comparision failed_num_comparision; close all;
    %format short
    %format rat
    format shortG
   ...
   % end
    ...
    if custom_center == 1
        ...
        attack_node = (size(honeycomb_g.A, 1));
        attack_val = avg_signal;
    end
%----
